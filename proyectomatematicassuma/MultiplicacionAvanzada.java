 ...
 * @author lizar
 */
public class MultiplicacionAvanzada extends javax.swing.JFrame {

    /**
     * Creates new form MultiplicacionAvanzada
     */
    public MultiplicacionAvanzada() {
        initComponents();
        setTitle("Multiplicación avanzada");
        imagen();
    ...
    public void Resultados() {
        ...
        String resultado1 = "19341";
        String resultado2 = "29325";
        String resultado3 = "90912";
        String resultado4 = "17343";
        String resultado5 = "14259";
        String resultado6 = "65949";

        String resultado7 = "48248";
        String resultado8 = "51188";
        String resultado9 = "47579";
        String resultado10 = "16965";
        String resultado11 = "25432";
        String resultado12 = "64328";
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel43, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 20, 610, 30));
        ...
        jPanel1.add(LbMarco, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 710, 580));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MultiplicacionAvanzada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MultiplicacionAvanzada().setVisible(true);
            }
        });
    }
