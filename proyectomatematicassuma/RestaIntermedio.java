 ...
 * @author lizar
 */
public class RestaIntermedio extends javax.swing.JFrame {

    /**
     * Creates new form RestaIntermedio
     */
    public RestaIntermedio() {
        initComponents();
        this.setTitle("Resta intermedia");
    ...
    public void imagen() {
//Foto de resta
        ImageIcon resta = new ImageIcon(getClass().getResource("/Imagenes/resta.gif"));
        ImageIcon marcoo = new ImageIcon(getClass().getResource("/Imagenes/marco3.gif"));
        Icon restaa = new ImageIcon(resta.getImage().getScaledInstance(LbResta.getWidth(), LbResta.getHeight(), Image.SCALE_DEFAULT));
        Icon marquito = new ImageIcon(marcoo.getImage().getScaledInstance(LbMarcooo.getWidth(), LbMarcooo.getHeight(), Image.SCALE_DEFAULT));
        LbResta.setIcon(restaa);
        LbMarcooo.setIcon(marquito);

    }

    public void Resultados() {

        String resultado1 = "933";
        String resultado2 = "612";
        String resultado3 = "521";
        String resultado4 = "713";
        String resultado5 = "645";
        String resultado6 = "525";

        String resultado7 = "333";
        String resultado8 = "221";
        String resultado9 = "312";
        String resultado10 = "122";
        String resultado11 = "211";
        String resultado12 = "421";
    ...
    private void initComponents() {
        ...
        LbMarcooo = new javax.swing.JLabel();
        ...
        jPanel1.add(btnVolver, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 440, 150, 60));
        ...
        jPanel1.add(btnRevisar, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 440, 150, 60));

        LbResta.setText("jLabel3");
        jPanel1.add(LbResta, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 490, 150, 140));

        LbIncorrect10.setText("jLabel2");
        jPanel1.add(LbIncorrect10, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 300, 30, 32));

        LbCorrect10.setText("jLabel2");
        jPanel1.add(LbCorrect10, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 300, 30, 32));
        ...
        jPanel1.add(TxtOp11, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 300, 81, -1));

        jLabel11.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel11.setText("952 - 741");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 300, -1, -1));

        LbIncorrect11.setText("jLabel2");
        jPanel1.add(LbIncorrect11, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 360, 30, 32));

        LbCorrect11.setText("jLabel2");
        jPanel1.add(LbCorrect11, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 360, 30, 32));
        ...
        jPanel1.add(TxtOp12, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 360, 81, -1));

        jLabel12.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel12.setText("842 - 421");
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 360, -1, -1));

        LbIncorrect1.setText("jLabel2");
        jPanel1.add(LbIncorrect1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 120, 30, 32));

        LbCorrect1.setText("jLabel2");
        jPanel1.add(LbCorrect1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 120, 30, 32));

        jLabel1.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel1.setText("986 - 53");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 60, 70, -1));
        ...
        jPanel1.add(TxtOp1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 60, 78, -1));

        LbCorrect.setText("jLabel2");
        jPanel1.add(LbCorrect, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 60, 30, 32));

        LbIncorrect.setText("jLabel2");
        jPanel1.add(LbIncorrect, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 60, 30, 32));

        jLabel2.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel2.setText("649 - 37");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 120, -1, -1));
        jPanel1.add(TxtOp2, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 120, 81, -1));
        ...
        jPanel1.add(TxtOp5, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 300, 81, -1));
        ...
        jPanel1.add(TxtOp6, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 360, 81, -1));
        ...
        jPanel1.add(LbIncorrect4, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 300, 30, 32));

        LbCorrect4.setText("jLabel2");
        jPanel1.add(LbCorrect4, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 300, 30, 32));

        LbIncorrect5.setText("jLabel2");
        jPanel1.add(LbIncorrect5, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 360, 30, 32));

        LbCorrect5.setText("jLabel2");
        jPanel1.add(LbCorrect5, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 360, 30, 32));

        LbIncorrect6.setText("jLabel2");
        jPanel1.add(LbIncorrect6, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 60, 30, 32));

        LbCorrect6.setText("jLabel2");
        jPanel1.add(LbCorrect6, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 60, 30, 32));

        LbIncorrect7.setText("jLabel2");
        jPanel1.add(LbIncorrect7, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 120, 30, 32));

        LbCorrect7.setText("jLabel2");
        jPanel1.add(LbCorrect7, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 120, 30, 32));
        ...
        jPanel1.add(TxtOp8, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 120, 81, -1));

        jLabel8.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel8.setText("734 - 513");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 120, -1, -1));

        LbIncorrect8.setText("jLabel2");
        jPanel1.add(LbIncorrect8, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 180, 30, 32));

        LbCorrect8.setText("jLabel2");
        jPanel1.add(LbCorrect8, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 180, 30, 32));
        ...
        jPanel1.add(TxtOp9, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 180, 81, -1));

        jLabel9.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel9.setText("722 - 410");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 180, 80, -1));

        LbIncorrect9.setText("jLabel2");
        jPanel1.add(LbIncorrect9, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 240, 30, 32));

        LbCorrect9.setText("jLabel2");
        jPanel1.add(LbCorrect9, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 240, 30, 32));
        ...
        jPanel1.add(TxtOp10, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 240, 81, -1));

        jLabel22.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel22.setText("363 - 241");
        jPanel1.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 240, -1, -1));
        ...
        LbMarcooo.setText("jLabel3");
        jPanel1.add(LbMarcooo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 690, 660));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RestaIntermedio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RestaIntermedio().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel LbMarcooo;
